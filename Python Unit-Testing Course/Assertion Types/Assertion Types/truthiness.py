...
class TestContainerTruthiness(unittest.TestCase):
    ...
    def test_list(self):
        self._test_container_class([], [1,2,3])

    def test_tuple(self):
        self._test_container_class((), (1,2,3,4))

    def test_set(self):
        self._test_container_class(set(), {'map', 'pint', 'parrot', 'leg'})

    def test_dict(self):
        self._test_container_class({}, {'ship':'pearl', 'year':2018})
